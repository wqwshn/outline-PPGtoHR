...
class BudgetContract:
    ...
    @classmethod
    def approved_v6_p25_diagnostic(cls) -> BudgetContract:
        """Return the contract for 36 bounded p25 spectral diagnostics."""

        prior = cls.approved_v5()
        return cls(
            stage_unique_limits={
                **prior.stage_unique_limits,
    ...
    @classmethod
    def proposed_v10_rank1_filter_revision(cls) -> BudgetContract:
        """Return the proposed contract for 12 rank-1 revision audits."""

        prior = cls.proposed_v9_filter_mechanism_decomposition()
        return cls(
            stage_unique_limits={
                **prior.stage_unique_limits,
            ...
            max_attempts=1728,
            retry_limit=prior.retry_limit,
            contract_version="lyx_recovery_filter_budget_v10",
            stage_attempt_kinds={
                **prior.stage_attempt_kinds,
                "filter_profile_rank1_revision_diagnostic": "diagnostic",
            },
        )
    ...
    @classmethod
    def proposed_v13_recovery_independent_bo(cls) -> BudgetContract:
        """Add the bounded 3 × 12 × 150 recovery independent-BO search."""

        prior = cls.proposed_v12_stage_r_rank1_runtime_fix()
        return cls(
            stage_unique_limits={
                **prior.stage_unique_limits,
                "recovery_independent_bo": 5400,
            },
            normal_unique_identity_limit=6324,
            supplemental_stage=prior.supplemental_stage,
            max_unique_identities=6336,
            max_attempts=12672,
            retry_limit=prior.retry_limit,
            contract_version="lyx_recovery_filter_budget_v13",
            stage_attempt_kinds={
                **prior.stage_attempt_kinds,
                "recovery_independent_bo": "formal",
            },
        )
    ...
    def migrate_to(
        ...
        *,
        ...
        known_transitions = {
            ...
            BudgetContract.proposed_v12_stage_r_rank1_runtime_fix().sha256: (
                BudgetContract.proposed_v13_recovery_independent_bo().sha256
            ),
        }
