...
class SpectrumTrackingTrace:
    ...
    low_reacquire_candidate_id: str = "legacy_v1"
    ...
    reacquire_owned_penalty_support_used: bool = False
    ...
    high_lock_owned_penalty_support: bool = False
    high_lock_final_action_consumed: bool = False
...
class SpectrumReacquireState:
    ...
    challenge_used_owned_penalty_support: bool = False
    accepted_owned_penalty_support_used: bool = False
...
def track_spectrum_window(
    ...
    *,
    ...
    low_reacquire_params: Any | None = None,
